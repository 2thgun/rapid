...
| RPD-003 | P1 | Validate deployed v4 with a live simulator | Six Pi suites and Windows-to-Pi UDP round trip pass; both components deployed and keys paired; live acceptance pending |
